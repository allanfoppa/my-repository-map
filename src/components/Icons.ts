// HEROICON: briefcase
export function BriefcaseIcon(): string {
  return `
...
// HEROICON: document
export function DocumentIcon(): string {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
// HEROICON: check
export function CheckIcon(classes: string): string {
  return `
...
// HEROICON: x-mark
export function XMarkIcon(): string {
  return `
